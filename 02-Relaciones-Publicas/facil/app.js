...
(function () {
  ...
  // --- Refuerzo: mini-tests bajo cada pregunta de autoevaluación ---
  // Formativos: corrigen al instante pero NO cuentan para el marcador ni el progreso.
  document.querySelectorAll(".refuerzo .qcard").forEach(qc => {
    const opts = Array.from(qc.querySelectorAll(".option"));
    const explain = qc.querySelector(".explain");
    opts.forEach(opt => {
      opt.addEventListener("click", () => {
